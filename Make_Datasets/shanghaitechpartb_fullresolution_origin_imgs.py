...
if __name__ == '__main__':
    image_root_path = '..\\datasets\\ShanghaiTech_Crowd_Counting_Dataset\\part_B_final\\train_data\\images'
    image_gt_path = '..\\datasets\\ShanghaiTech_Crowd_Counting_Dataset\\part_B_final\\train_data\\ground_truth'
    image_save_path = '..\\datasets\\ShanghaiTechPartB\\fullresolution\\origin\\Train\\'
    image_gt_save_path = '..\\datasets\\ShanghaiTechPartB\\fullresolution\\origin\\Train_gt'

    if os.path.exists(image_save_path) == False:
        os.makedirs(image_save_path)
    if os.path.exists(image_gt_save_path) == False:
        os.makedirs(image_gt_save_path)
    

    main(image_root_path, image_gt_path, image_save_path, image_gt_save_path)

    image_root_path = '..\\datasets\\ShanghaiTech_Crowd_Counting_Dataset\\part_B_final\\test_data\\images'
    image_gt_path = '..\\datasets\\ShanghaiTech_Crowd_Counting_Dataset\\part_B_final\\test_data\\ground_truth'
    image_save_path = '..\\datasets\\ShanghaiTechPartB\\fullresolution\\origin\\Test\\'
    image_gt_save_path = '..\\datasets\\ShanghaiTechPartB\\fullresolution\\origin\\Test_gt'
